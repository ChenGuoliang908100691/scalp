<template>
	<view class="pinduoduoBinding">
		...
		<view class="example" @click="toPDDexample">
			进入查看绑定要求
		</view>
		<view class="warning">
			<view class="text">
		...
		<view class="property">
			...
			<view class="content">
				...
				<view class="cu-form-group">
					...
					<input placeholder="输入最新一笔拼多多订单" name="input"></input>
				</view>
			</view>
		</view>
